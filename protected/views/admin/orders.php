...
<div class="col-md-12">
    <div class="col-md-12 clear">
        ...
        <div class="col-md-7 badges">
            ...
            {
                echo '<div class="col-md-3"><button disabled class="btn btn-primary col-md-12" href="#">'.$col.' <span class="badge">'.$counters[$status].'</span></button></div>';
            }
            ?>
        </div>
    </div>
...
<div class="col-md-12 order-info-ext">
    <div class="col-md-12">
    ...
    {
        ?>
        <div class="col-md-12 order-review-form">
            <div class="col-md-12">
    ...
    <?php
        ...
        ?>
        <div class="col-md-6 order-review-form hidden clear">
        ...
        <div class="col-md-6 order-comments clear">
